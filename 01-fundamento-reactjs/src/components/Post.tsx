...
export function Post({ post }:PostProps) {
    ...
    ); //estado que verifica a mudança na lista de comments

    const [newCommentText, setNewCommentText] = useState('') //estado que vai armazenar o valor mais recente da textarea
        ...
        <article className={styles.post}>
            <header>
                <div className={styles.author}>
                    <Avatar src={post.author.avatarUrl} alt="Foto de Perfil" />
